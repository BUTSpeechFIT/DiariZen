...
diar_pipeline = DiariZenPipeline(Path(diarizen_hub).expanduser().absolute(), embedding_model="redimnet:b1:ft_lm:vox2", config_parse = toml.load(config_parse_path.as_posix()))
