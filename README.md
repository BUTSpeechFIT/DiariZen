...
- The **pre-trained model weights** are released under the [CC BY-NC 4.0](https://github.com/BUTSpeechFIT/DiariZen/blob/main/MODEL_LICENSE) license. By downloading these weights, you agree to the non-commercial terms and the compliance details outlined below.

### Important Compliance Note
The **CC BY-NC 4.0** license for model weights is chosen to ensure maximum compliance with the most restrictive source datasets used during training (e.g., **RAMC**, **MSDWild**, and **DIHARD-3**), all of which explicitly prohibit commercial use.
